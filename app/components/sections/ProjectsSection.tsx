...
const FOG = 'radial-gradient(ellipse 55% 50% at 28% 32%, rgba(251,191,36,0.22) 0%, transparent 62%), radial-gradient(ellipse 50% 55% at 74% 66%, rgba(245,158,11,0.14) 0%, transparent 58%), radial-gradient(ellipse 95% 85% at 50% 50%, rgba(254,243,199,0.48) 0%, transparent 88%), #ede5d8'
